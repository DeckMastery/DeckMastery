...
const MAP = {
  ...
  "لديك دروس فائتة. اختر الإجراء لكل درس.": "You have missed lessons. Choose an action for each one.",
  "إجراءات للكل": "Actions for all",
  "استمرار بالكل": "Continue all",
  "إعادة الكل": "Restart all",
  "تجاهل الكل": "Ignore all",
  "بطاقات": "Cards",
  "بطاقات اللعب اليوم": "Daily Play Cards",
  "الكتابة": "Typing",
  "اللعب": "Play",
  ...
  "لا توجد بطاقات بعد.\nأضف 4 بطاقات على الأقل لتبدأ.": "No cards yet.\nAdd at least 4 cards to start.",
  "لا توجد بطاقات لليوم.\nأضف بطاقات جديدة أو عد غدًا.": "No cards due today.\nAdd new cards or come back tomorrow.",
  "لا توجد بطاقات كافية للتدريب.\nاختر 4 بطاقات على الأقل من رزم البطاقات.": "Not enough cards for training.\nPick at least 4 cards from packs.",
